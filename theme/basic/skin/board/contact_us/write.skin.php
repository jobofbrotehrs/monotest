    ...
    <?php } ?>
        ...
        <article class="contact_container">
            <div class="inner">
                ...
                <p class="t2">
                    Thank you for your interest in SolvistWorldwide. <br/>
                    To speak with a representative, please complete the form below or call +82 2 783 3055<br/>
                    for international callers. One of our experts will follow up with you shortly.
                </p>
                <ul class="form_contain">
                    <li class="half">
                        <p class="label">First Name <b>*</b></p>
                        <p class="ipt_wrap">
                            <input type="text" name="wr_1" value="<?=$write['wr_1'];?>" required placeholder=""/>
                        </p>
                    </li>
                    <li class="half">
                        <p class="label">Last Name <b>*</b></p>
                        <p class="ipt_wrap">
                            <input type="text" name="wr_2" value="<?=$write['wr_2'];?>" required placeholder=""/>
                        </p>
                    </li>
                    <li class="half">
                        <p class="label">Company <b>*</b></p>
                        <p class="ipt_wrap">
                            <input type="text" name="wr_subject" value="<?=$write['wr_subject'];?>" required placeholder=""/>
                        </p>
                    </li>
                    <li class="half">
                        <p class="label">Job Title <b>*</b></p>
                        <p class="ipt_wrap">
                            <input type="text" name="wr_3" value="<?=$write['wr_3'];?>" required placeholder=""/>
                        </p>
                    </li>
                    <li class="half">
                        <p class="label">Email Address <b>*</b></p>
                        <p class="ipt_wrap">
                            <input type="text" name="wr_4" value="<?=$write['wr_4'];?>" required placeholder=""/>
                        </p>
                    </li>
                    <li class="half">
                        <p class="label">Phone Number <b>*</b></p>
                        <p class="ipt_wrap">
                            <input type="text" name="wr_5" value="<?=$write['wr_5'];?>" placeholder=""/>
                        </p>
                    </li>
                    <li class="">
                        <p class="label">How can we help you ? <b>*</b></p>
                        <p class="ipt_wrap">
