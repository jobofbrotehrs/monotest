...
<section class="sub_sec sub01 sub01_1">
        ...
        <div class="content_wrap">
            <div class="inner">
                <div class="content">
                    ...
                    <p class="t2"> SOLVIST WORLDWIDE<br/>Our experts’ Core Value</p>
                </div>
            </div>
        </div>
    ...
    <article class="main_sol_w sol_w">
        <div class="inner">
            <p class="t1">Our experts’ Core Value</p>
            <ul class="s_list">
                <li>
                    <div class="contnet_wrap">
                        ...
                        <p class="content">
                            We comply with basic <br/>
                            and fundamental code <br/>
                            of ethics as professionals. 
                        </p>
                    </div>
                </li>
                <li>
                    <div class="contnet_wrap">
                        ...
                        <p class="content">
                            We build up Change Agents <br/>
                            in the 318 global companies <br/>
                            through Solvist Practice.
                        </p>
                    </div>
                </li>
                <li>
                    <div class="contnet_wrap">
                        ...
                        <p class="content">
                            We operate Leadership <br/>
                            School for the coming <br/>
                            next generation.
                        </p>
                    </div>
                </li>
                <li>
                    <div class="contnet_wrap">
                        ...
                        <p class="content">
                            We set up the Internship <br/>
                            platform for the next <br/>
                            generation to generate Change <br/>
                            Agents who will build up the <br/>
                            effectiveness of each <br/>
                            organization. 
                        </p>
                    </div>
                </li>
                <li>
                    <div class="contnet_wrap">
                        ...
                        <p class="content">
                            We prepare that Solvist <br/>
                            Practice could be a global <br/>
                            systemized module according <br/>
                            to each strategy of <br/>
                            organizations.
                        </p>
                    </div>
                </li>
